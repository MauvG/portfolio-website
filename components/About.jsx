      ...
      <div className="lg:block hidden">
        ...
        <div className="flex justify-center m-5 items-center">
          ...
          <div className="flex-1 m-5">
            ...
            <br />
            <p>
              I have a strong interest in computer science and I'm eager to
              learn more. I want to take on fresh tasks and work through
              difficult issues. I enjoy working in teams and I'm constantly
              seeking for intriguing chances to put my abilities to the test.
            </p>
          </div>
        </div>
      </div>
